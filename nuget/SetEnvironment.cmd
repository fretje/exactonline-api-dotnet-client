...
if not defined DevEnvDir (
	if exist "%ProgramFiles%\Microsoft Visual Studio\2022\Enterprise\Common7\Tools\vsMSBuildCmd.bat" (
		call "%ProgramFiles%\Microsoft Visual Studio\2022\Enterprise\Common7\Tools\vsMSBuildCmd.bat"
	) else if exist "%ProgramFiles%\Microsoft Visual Studio\2022\Preview\Common7\Tools\vsMSBuildCmd.bat" (
		call "%ProgramFiles%\Microsoft Visual Studio\2022\Preview\Common7\Tools\vsMSBuildCmd.bat"
	) else if exist "%ProgramFiles(x86)%\Microsoft Visual Studio\2019\Enterprise\Common7\Tools\vsMSBuildCmd.bat" (
